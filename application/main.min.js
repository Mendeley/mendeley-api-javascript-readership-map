try{window.oauthImplicitGrantConfig={clientId:917,responseType:"token"}}catch(e){console.info("Client side oauth config ignored"),module.exports&&(module.exports={responseType:"token"})}
